...
@Component
public class PrecontactUpdateHandler extends AbstractUpdateHandler {
    protected PrecontactUpdateHandler(UserService userService, TaskService taskService, TaskLogService taskLogService) {
        super(userService, taskService, taskLogService);
    }

    @Override
    protected void handle(Update update, SendMessage answer, User user) {
        answer.setText("Идёт преконтакт...");
    }
